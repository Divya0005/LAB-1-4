...
printf("Enter sales:");
scanf("%d",&sales);
if(sales>=0 && sales<=500) com=sales*5/100;
else if(sales>500 && sales<=2000) com=35+(sales-500)*10/100;
else if(sales>2000 && sales<=5000) com=185+(sales-2000)*12/100;
else if(sales>5000)                com=sales*12.5/100; 
